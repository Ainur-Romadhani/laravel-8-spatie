    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            @foreach($permission as $value)
                <input class="form-check-input" value="{{ $value->id }}" name="permission[]" type="checkbox" id="flexSwitchCheckDefault" @if( in_array($value->id, $rolePermissions) ) checked="1" @endif />
